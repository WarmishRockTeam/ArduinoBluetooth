...
public class MainActivity extends AppCompatActivity {
    ...
    public void addComponents(){
        ...
        mDevicesListView = (ListView)findViewById(R.id.listBox1);
    }
    ...
    private void discover(MenuItem item){
    ...
    private void listPairedDevices(MenuItem item){
